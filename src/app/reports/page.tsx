    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto min-h-screen">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Analyze your performance with custom business reports.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col items-center justify-center min-h-[400px]">
        ...
        <p className="text-gray-500 text-center max-w-md">
          This page represents the Reports dashboard view. The full responsive layout with sidebar and headers is loaded correctly.
        </p>
      </div>
    </div>
  );
