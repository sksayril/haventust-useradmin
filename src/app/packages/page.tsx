        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-1.5 shadow-sm flex items-center gap-1.5">
            <button
              ...
              className={`flex-1 py-3 px-4 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer ${activeTab === "Gold"
            ...
            <button
              ...
              className={`flex-1 py-3 px-4 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer ${activeTab === "Land"
                  ? "bg-[#0b5be6] text-white shadow-md shadow-blue-500/10"
                  : "text-gray-500 hover:text-gray-800 hover:bg-gray-50"
                }`}
            >
                  ...
                  return (
                    <tr key={p._id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="py-3.5 px-4">
                        <span className={`inline-block px-2 py-0.5 rounded-lg text-[9px] font-black uppercase ${p.type === "Gold" ? "bg-yellow-50 text-yellow-600 border border-yellow-100" : "bg-blue-50 text-blue-600 border border-blue-100"
                          }`}>
                          {p.type} Package
                        </span>
                      </td>
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <span className={`inline-block px-2 py-0.5 rounded-full text-[9px] font-black uppercase ${p.status === "Approved"
