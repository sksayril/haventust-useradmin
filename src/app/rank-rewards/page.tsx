    ...
    <div className="w-full min-h-screen bg-[#f3f7fd] p-4 md:p-8 select-none text-left">
        ...
        <div className="mb-6">
          <h2 className="text-base font-black text-gray-900 tracking-tight flex items-center gap-2 mb-4">
            ...
            <span>Haventist Rank Milestones &amp; Salary Structure</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {RANKS_LIST.map((rank, index) => {
              ...
              return (
                <div 
                  key={rank.name} 
                  className={`bg-white border rounded-3xl p-5 shadow-sm relative overflow-hidden transition-all flex flex-col justify-between min-h-[160px] ${
                    isAchieved ? "border-emerald-200 bg-emerald-50/10" : "border-gray-100"
                  }`}
                >
